...
from CORE_Algorithms.Sorting.quick_sort import quick_sort_recurse
...
class TestSortFunctions(unittest.TestCase):
    __sort_functions: List[SortFunction] = [quick_sort_recurse, insertion_sort, bubble_sort, merge_sort]
